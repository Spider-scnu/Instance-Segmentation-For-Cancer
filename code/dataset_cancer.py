...
def main(config):
    ...
    for filename in filenames:
        ...
        if ext =='.png':
            filename = filename.split('/')[-1][:-len('.png')]
...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='../ISIC/dataset/cancer/Input')
    parser.add_argument('--origin_GT_path', type=str, default='../ISIC/dataset/cancer/Mask')
    
    parser.add_argument('--train_path', type=str, default='./dataset/traincancer/')
    parser.add_argument('--train_GT_path', type=str, default='./dataset/traincancer_GT/')
    parser.add_argument('--valid_path', type=str, default='./dataset/validcancer/')
    parser.add_argument('--valid_GT_path', type=str, default='./dataset/validcancer_GT/')
    parser.add_argument('--test_path', type=str, default='./dataset/testcancer/')
    parser.add_argument('--test_GT_path', type=str, default='./dataset/testcancer_GT/')
